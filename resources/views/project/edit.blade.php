                        ...
                        <div class="container">
                            ...
                            <div class="row">
                                <div class="col-sm-8">
                                    ...
                                    <form class="form" id="createForm" action="{{ url('app/'.$project -> id) }}"
                                        ...
                                        <span style="padding-left: 15px;" class="input-group-addon">
                                            <i class="fa fa-link" aria-hidden="true"></i>
                                                ...
                                                <input name="link" id="link" type="url" class="form-control"
                                                       placeholder="https://link..." value="{{ $project -> link }}"
                                                       required="required"/>
                                            </div>
                                            <div class="space-10"></div>
                                            <div>
                                        ...
                                        <small class="text-danger">Please Enter all required field <img
                                                    src="http://portal.um6p.ma/assets/img/required.png" alt="required">
                                        </small>
                                        <div class="space-10"></div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <button class="btn btn-primary btn-round btn-simple btn-block btn-lg button-create"
                                                            id="update" type="submit">Update Project
                                                    </button>
                                                </div>
                                                <div class="col-sm-6">
                                                    <a href="{{ url('app') }}"
