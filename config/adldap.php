            ...
            */
            ...
            'connection_settings' => [
                ...
                */
                ...
                'domain_controllers' => explode(' ', env('ADLDAP_CONTROLLERS', 'prdadum6p-03.um6p.local')),
                ...
                */
                ...
                'base_dn' => env('ADLDAP_BASEDN', 'CN=Users,DC=UM6P,DC=local'),
                ...
                */
                ...
                'admin_username' => env('ADLDAP_ADMIN_USERNAME', 'abdeljalil.benettaleb@um6p.ma'),
                'admin_password' => env('ADLDAP_ADMIN_PASSWORD', 'Abdeljalil@1994'),
